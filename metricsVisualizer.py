...
"""
IL SEGUENTE È UN COMMENTO GENERALE PER SPIEGARE COME FUNZIONA LA CLASSE "metricsVisualizer", successivamente ci saranno dei commenti più specifici per ogni funzione.
...
e "Prevision" contenente tante tabelle quanti sono gli esperimenti, in ognuna di esse vengono associati il Sample code number con la relativa previsione effettuata dal modello.
"""
...
class MetricsVisualizer:
    ...
    def __init__(self, method_input, df, scelta_num):
        ...
        # grazie all'uso del dizionario "metrics_dict" è possibile associare a ogni numero inserito dall'utente la metrica corrispondente
        self.metrics_dict = {
            1: "Accuracy rate",
            2: "Error rate",
            3: "Sensitivity",
    ...
    def save_to_excel(self, results, scelta, df2):
        """
           Questa funzione si occupa del salvataggio dei dati nel file excel "risultati.xlsx" in due fogli separati: "Metrics Results" e "Prevision" solo nel CASO 1 (holdout)
    ...
    def plot_metrics(self, results, scelta, df):
        """
           Questa funzione si occupa del salvataggio del plot tramite un immagine con estensione png nella cartella corrente solo nel CASO 2 (stratified cross validation)
           la funzione "plot_metrics" non restituisce alcun valore ma chiama la funzione "save_to_excel_with_plots" per il salvataggio e visualizzazione dei risultati in excel
    ...
    def save_to_excel_with_plots(self, plot_filename, df):
        """
           Questa funzione si occupa del salvataggio dei dati su excel solo nel CASO 2 (stratified cross validation) nel file "risultati.xlsx"
